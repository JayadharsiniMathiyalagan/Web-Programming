...
export default function MusicStore() {
  ...
  const addItem = () => {
    ...
    const nextId = inventory.length === 0 ? 1 : Math.max(...inventory.map((i) => i.id)) + 1;
    ...
    <div className="container my-4">
      ...
      <div className="card h-100 shadow-sm">
        <div className="card-body">
          ...
          {/* Add form */}
          <h2 className="text-info text-center mt-4 mb-3">Add New Instrument</h2>
          <div className="row g-2 align-items-stretch">
            ...
            <div className="col-md-2 d-grid">
              <button className="btn btn-warning w-100 fw-bold" onClick={addItem}>
                Add Item
              </button>
            </div>
          </div>
